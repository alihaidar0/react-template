...
4. The container pulls `alihaidar199527/react-devcontainer:latest` from Docker Hub
...
| **Source** | [`github.com/alihaidar0/react-devcontainer`](https://github.com/alihaidar0/react-devcontainer) |
...
| Repo | Purpose |
|------|---------|
| [`react-devcontainer`](https://github.com/alihaidar0/react-devcontainer) | Builds and publishes the base dev Docker image |
| [`react-template`](https://github.com/alihaidar0/react-template) | ← You are here |
